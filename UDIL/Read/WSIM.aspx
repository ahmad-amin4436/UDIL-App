...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="main-content">
        <div class="container-fluid mt-5">
            <section id="wsim-read">
                <h2 class="section-header"><i class="bi bi-search"></i> WSIM - On Demand Read</h2>
                <div class="card">

                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblWsimTransactionId" runat="server" AssociatedControlID="wsimTransactionId" CssClass="form-label" Text="Transaction ID"></asp:Label>
                                <asp:TextBox ID="wsimTransactionId" runat="server" CssClass="form-control" ReadOnly="true" />
                            </div>
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblWsimPrivateKey" runat="server" AssociatedControlID="wsimPrivateKey" CssClass="form-label" Text="Private Key"></asp:Label>
                                <asp:TextBox ID="wsimPrivateKey" runat="server" CssClass="form-control" placeholder="private key from session" Enabled="false" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblWsimGlobalDeviceId" runat="server" AssociatedControlID="wsimGlobalDeviceId" CssClass="form-label" Text="Global Device ID"></asp:Label>
                                <asp:TextBox ID="wsimGlobalDeviceId" runat="server" CssClass="form-control" placeholder="Global Device ID" Text="m97999989" />
                            </div>
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblWsimType" runat="server" AssociatedControlID="wsimType" CssClass="form-label" Text="Type"></asp:Label>
                                <asp:DropDownList ID="wsimType" runat="server" CssClass="form-select">
                                    <asp:ListItem Value="WSIM" Selected="True">WSIM</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="position-relative d-inline-block">
                            <asp:Button
                                ...
                                Text="Read WSIM"
                                OnClick="btnWsimRead_Click"
                                OnClientClick="showWsimLoading(this); return true;" />
                        ...
                        <a href="WSIM.aspx" class="btn btn-secondary ms-2">Reset</a>
                        <asp:Label ID="lblWsimMessage" runat="server" CssClass="mt-3 d-block"></asp:Label>
                    </div>
                 </div>
                ...
                <asp:UpdatePanel ID="updResponse" runat="server">
                                ...
                                <div class="card-header border-0">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center gap-3">
                                            <h5 class="mb-0">WSIM Response</h5>
                                            <asp:Label ID="lblResponseStatus" runat="server" CssClass="badge bg-success px-3 py-2" />
                                        </div>
                                        <div>
                                            <asp:Button ID="btnWsimResponsePass" runat="server" CssClass="btn btn-success btn-sm" Text="Pass" OnClick="btnWsimResponsePass_Click" />
                                            <asp:Button ID="btnWsimResponseFail" runat="server" CssClass="btn btn-danger btn-sm ms-2" Text="Fail" OnClick="btnWsimResponseFail_Click" />
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">WSIM DateTime</small>
                                                    <asp:Label ID="lblRespWsimDateTime" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">WSIM Wakeup Number 1</small>
                                                    <asp:Label ID="lblRespWsimWakeupNumber1" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">WSIM Wakeup Number 2</small>
                                                    <asp:Label ID="lblRespWsimWakeupNumber2" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">WSIM Wakeup Number 3</small>
                                                    <asp:Label ID="lblRespWsimWakeupNumber3" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Response Remarks Section -->
                                    <div id="wsimResponseRemarks" runat="server" class="mt-3" style="display: none;">
                                        <div class="card border-warning">
                                            <div class="card-body">
                                                <h6 class="card-title">Remarks</h6>
                                                <asp:TextBox ID="txtWsimResponseRemarks" runat="server" CssClass="form-control mb-2" TextMode="MultiLine" Rows="2" placeholder="Enter remarks..."></asp:TextBox>
                                                <div class="mt-2">
                                                    <asp:Button ID="btnSaveWsimResponseRemarks" runat="server" CssClass="btn btn-dark-primary btn-sm me-1" Text="Save Remarks" OnCommand="SaveRemarks_Command" CommandName="Save" CommandArgument="WSIMResponse" />
                                                    <asp:Button ID="btnCancelWsimResponseRemarks" runat="server" CssClass="btn btn-secondary btn-sm ms-2" Text="Cancel" OnCommand="CancelRemarks_Command" CommandName="Cancel" CommandArgument="WSIMResponse" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="btnWsimRead" EventName="Click" />
                        <asp:AsyncPostBackTrigger ControlID="btnWsimResponsePass" EventName="Click" />
                        <asp:AsyncPostBackTrigger ControlID="btnWsimResponseFail" EventName="Click" />
                        <asp:AsyncPostBackTrigger ControlID="btnSaveWsimResponseRemarks" EventName="Click" />
                        <asp:AsyncPostBackTrigger ControlID="btnCancelWsimResponseRemarks" EventName="Click" />
                    </Triggers>
                </asp:UpdatePanel>
...
<asp:Content ID="ScriptsContent" ContentPlaceHolderID="ScriptsContent" runat="server">
    ...
    <script>
        function showWsimLoading(button) {
            if (!button) return;

            const spinner = document.getElementById('wsimSpinner');
        ...
        function disableWsimButton() {
            const button = document.getElementById('<%= btnWsimRead.ClientID %>');
            const spinner = document.getElementById('wsimSpinner');
