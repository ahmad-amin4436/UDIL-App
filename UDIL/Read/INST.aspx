    ...
    <div class="main-content">
        <div class="container-fluid mt-5">
            <section id="ippo-read">
                <h2 class="section-header"><i class="bi bi-search"></i> INST - On Demand Read</h2>
                <div class="card">

                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblInstTransactionId" runat="server" AssociatedControlID="instTransactionId" CssClass="form-label" Text="Transaction ID"></asp:Label>
                                <asp:TextBox ID="instTransactionId" runat="server" CssClass="form-control" ReadOnly="true" />
                            </div>
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblInstPrivateKey" runat="server" AssociatedControlID="instPrivateKey" CssClass="form-label" Text="Private Key"></asp:Label>
                                <asp:TextBox ID="instPrivateKey" runat="server" CssClass="form-control" placeholder="private key from session" Enabled="false" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblInstGlobalDeviceId" runat="server" AssociatedControlID="instGlobalDeviceId" CssClass="form-label" Text="Global Device ID"></asp:Label>
                                <asp:TextBox ID="instGlobalDeviceId" runat="server" CssClass="form-control" placeholder="Global Device ID" Text="m97999989" />
                            </div>
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblInstType" runat="server" AssociatedControlID="instType" CssClass="form-label" Text="Type"></asp:Label>
                                <asp:DropDownList ID="instType" runat="server" CssClass="form-select">
                                    <asp:ListItem Value="INST" Selected="True">INST</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="position-relative d-inline-block">
                            <asp:Button
                                ...
                                Text="Read INST"
                                OnClick="btnInstRead_Click"
                                OnClientClick="showInstLoading(this); return true;" />
                        ...
                        <a href="INST.aspx" class="btn btn-secondary ms-2">Reset</a>
                        <asp:Label ID="lblInstMessage" runat="server" CssClass="mt-3 d-block"></asp:Label>
                    </div>
                 </div>
                ...
                <asp:UpdatePanel ID="updResponse" runat="server">
                                ...
                                <div class="card-header border-0">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center gap-3">
                                            <h5 class="mb-0">INST Response</h5>
                                            <asp:Label ID="lblResponseStatus" runat="server" CssClass="badge bg-success px-3 py-2" />
                                        </div>
                                        <div>
                                            <asp:Button ID="btnInstResponsePass" runat="server" CssClass="btn btn-success btn-sm" Text="Pass" OnClick="btnInstResponsePass_Click" />
                                            <asp:Button ID="btnInstResponseFail" runat="server" CssClass="btn btn-danger btn-sm ms-2" Text="Fail" OnClick="btnInstResponseFail_Click" />
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">Meter DateTime</small>
                                                    <asp:Label ID="lblRespMeterDateTime" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">MDC Read DateTime</small>
                                                    <asp:Label ID="lblRespMdcReadDateTime" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">Voltage Phase A</small>
                                                    <asp:Label ID="lblRespVoltagePhaseA" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">Current Phase A</small>
                                                    <asp:Label ID="lblRespCurrentPhaseA" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    ...
                                                    <asp:Label ID="lblRespFrequency" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    ...
                                                    <asp:Label ID="lblRespSignalStrength" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">DB DateTime</small>
                                                    <asp:Label ID="lblRespDbDateTime" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">Voltage Phase B</small>
                                                    <asp:Label ID="lblRespVoltagePhaseB" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">Voltage Phase C</small>
                                                    <asp:Label ID="lblRespVoltagePhaseC" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">Current Phase B</small>
                                                    <asp:Label ID="lblRespCurrentPhaseB" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">Current Phase C</small>
                                                    <asp:Label ID="lblRespCurrentPhaseC" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">Aggregate Reactive Pwr Neg</small>
                                                    <asp:Label ID="lblRespAggregateReactivePwrNeg" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">Aggregate Reactive Pwr Pos</small>
                                                    <asp:Label ID="lblRespAggregateReactivePwrPos" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">Aggregate Active Pwr Neg</small>
                                                    <asp:Label ID="lblRespAggregateActivePwrNeg" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">Current Tariff Register</small>
                                                    <asp:Label ID="lblRespCurrentTariffRegister" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">Aggregate Active Pwr Pos</small>
                                                    <asp:Label ID="lblRespAggregateActivePwrPos" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">Aggregate Reactive Pwr Abs</small>
                                                    <asp:Label ID="lblRespAggregateReactivePwrAbs" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">Aggregate Active Pwr Abs</small>
                                                    <asp:Label ID="lblRespAggregateActivePwrAbs" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">Average PF</small>
                                                    <asp:Label ID="lblRespAveragePf" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">Is Synced</small>
                                                    <asp:Label ID="lblRespIsSynced" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Response Remarks Section -->
                                    <div id="instResponseRemarks" runat="server" class="mt-3" style="display: none;">
                                        <div class="card border-warning">
                                            <div class="card-body">
                                                <h6 class="card-title">Remarks</h6>
                                                <asp:TextBox ID="txtInstResponseRemarks" runat="server" CssClass="form-control mb-2" TextMode="MultiLine" Rows="2" placeholder="Enter remarks..."></asp:TextBox>
                                                <div class="mt-2">
                                                    <asp:Button ID="btnSaveInstResponseRemarks" runat="server" CssClass="btn btn-dark-primary btn-sm me-1" Text="Save Remarks" OnClick="btnSaveInstResponseRemarks_Click" />
                                                    <asp:Button ID="btnCancelInstResponseRemarks" runat="server" CssClass="btn btn-secondary btn-sm ms-2" Text="Cancel" OnClick="btnCancelInstResponseRemarks_Click" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <Triggers>
                        ...
                        <asp:AsyncPostBackTrigger ControlID="btnInstResponsePass" EventName="Click" />
                        <asp:AsyncPostBackTrigger ControlID="btnInstResponseFail" EventName="Click" />
                        <asp:AsyncPostBackTrigger ControlID="btnSaveInstResponseRemarks" EventName="Click" />
                        <asp:AsyncPostBackTrigger ControlID="btnCancelInstResponseRemarks" EventName="Click" />
                    </Triggers>
                </asp:UpdatePanel>
...
<asp:Content ID="ScriptsContent" ContentPlaceHolderID="ScriptsContent" runat="server">
    ...
    <script>
        function showInstLoading(button) {
            if (!button) return;
        ...
        function disableInstButton() {
            const button = document.getElementById('<%= btnInstRead.ClientID %>');
            const spinner = document.getElementById('instSpinner');
