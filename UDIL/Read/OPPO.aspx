<%@ Page Title="UDIL Tester - OPPO - ODR" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
   CodeBehind="OPPO.aspx.cs" Inherits="UDIL.Read.OPPO" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

    <div class="main-content">
        <div class="container-fluid mt-5">
            <section id="oppo-read">
                <h2 class="section-header"><i class="bi bi-search"></i> OPPO - On Demand Read</h2>
                <div class="card">

                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblOppTransactionId" runat="server" AssociatedControlID="oppoTransactionId" CssClass="form-label" Text="Transaction ID"></asp:Label>
                                <asp:TextBox ID="oppoTransactionId" runat="server" CssClass="form-control" ReadOnly="true" />
                            </div>
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblOppoPrivateKey" runat="server" AssociatedControlID="oppoPrivateKey" CssClass="form-label" Text="Private Key"></asp:Label>
                                <asp:TextBox ID="oppoPrivateKey" runat="server" CssClass="form-control" placeholder="private key from session" Enabled="false" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblOppoGlobalDeviceId" runat="server" AssociatedControlID="oppoGlobalDeviceId" CssClass="form-label" Text="Global Device ID"></asp:Label>
                                <asp:TextBox ID="oppoGlobalDeviceId" runat="server" CssClass="form-control" placeholder="Global Device ID" Text="m97999989" />
                            </div>
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblOppoType" runat="server" AssociatedControlID="oppoType" CssClass="form-label" Text="Type"></asp:Label>
                                <asp:DropDownList ID="oppoType" runat="server" CssClass="form-select">
                                    <asp:ListItem Value="OPPO" Selected="True">OPPO</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="position-relative d-inline-block">
                            <asp:Button
                                ...
                                Text="Read OPPO"
                                OnClick="btnOppoRead_Click"
                                OnClientClick="showOppoLoading(this); return true;" />
                        ...
                        <a href="OPPO.aspx" class="btn btn-secondary ms-2">Reset</a>
                        <asp:Label ID="lblOppoMessage" runat="server" CssClass="mt-3 d-block"></asp:Label>
                    </div>
                 </div>
                ...
                <asp:UpdatePanel ID="updResponse" runat="server">
                                ...
                                <div class="card-header border-0">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center gap-3">
                                            <h5 class="mb-0">OPPO Response</h5>
                                            <asp:Label ID="lblResponseStatus" runat="server" CssClass="badge bg-success px-3 py-2" />
                                        </div>
                                        <div>
                                            <asp:Button ID="btnOppoResponsePass" runat="server" CssClass="btn btn-success btn-sm" Text="Pass" OnClick="btnOppoResponsePass_Click" />
                                            <asp:Button ID="btnOppoResponseFail" runat="server" CssClass="btn btn-danger btn-sm ms-2" Text="Fail" OnClick="btnOppoResponseFail_Click" />
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">OPPO DateTime</small>
                                                    <asp:Label ID="lblRespOppoDateTime" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">OPPO Optical Port On DateTime</small>
                                                    <asp:Label ID="lblRespOppoOpticalPortOnDateTime" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">OPPO Optical Port Off DateTime</small>
                                                    <asp:Label ID="lblRespOppoOpticalPortOffDateTime" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Response Remarks Section -->
                                    <div id="oppoResponseRemarks" runat="server" class="mt-3" style="display: none;">
                                        <div class="card border-warning">
                                            <div class="card-body">
                                                <h6 class="card-title">Remarks</h6>
                                                <asp:TextBox ID="txtOppoResponseRemarks" runat="server" CssClass="form-control mb-2" TextMode="MultiLine" Rows="2" placeholder="Enter remarks..."></asp:TextBox>
                                                <div class="mt-2">
                                                    <asp:Button ID="btnSaveOppoResponseRemarks" runat="server" CssClass="btn btn-dark-primary btn-sm me-1" Text="Save Remarks" OnCommand="SaveRemarks_Command" CommandName="Save" CommandArgument="OPPOResponse" />
                                                    <asp:Button ID="btnCancelOppoResponseRemarks" runat="server" CssClass="btn btn-secondary btn-sm ms-2" Text="Cancel" OnCommand="CancelRemarks_Command" CommandName="Cancel" CommandArgument="OPPOResponse" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="btnOppoRead" EventName="Click" />
                        <asp:AsyncPostBackTrigger ControlID="btnOppoResponsePass" EventName="Click" />
                        <asp:AsyncPostBackTrigger ControlID="btnOppoResponseFail" EventName="Click" />
                        <asp:AsyncPostBackTrigger ControlID="btnSaveOppoResponseRemarks" EventName="Click" />
                        <asp:AsyncPostBackTrigger ControlID="btnCancelOppoResponseRemarks" EventName="Click" />
                    </Triggers>
                </asp:UpdatePanel>
...
<asp:Content ID="ScriptsContent" ContentPlaceHolderID="ScriptsContent" runat="server">
    ...
    <script>
        function showOppoLoading(button) {
            if (!button) return;

            const spinner = document.getElementById('oppoSpinner');
        ...
        function disableOppoButton() {
            const button = document.getElementById('<%= btnOppoRead.ClientID %>');
            const spinner = document.getElementById('oppoSpinner');
