<%@ Page Title="UDIL Tester - IPPO - ODR" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
   CodeBehind="IPPO.aspx.cs" Inherits="UDIL.Read.IPPO" %>
    ...
    <div class="main-content">
        <div class="container-fluid mt-5">
            <section id="ippo-read">
                <h2 class="section-header"><i class="bi bi-search"></i> IPPO - On Demand Read</h2>
                <div class="card">

                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblIppoTransactionId" runat="server" AssociatedControlID="ippoTransactionId" CssClass="form-label" Text="Transaction ID"></asp:Label>
                                <asp:TextBox ID="ippoTransactionId" runat="server" CssClass="form-control" ReadOnly="true" />
                            </div>
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblIppoPrivateKey" runat="server" AssociatedControlID="ippoPrivateKey" CssClass="form-label" Text="Private Key"></asp:Label>
                                <asp:TextBox ID="ippoPrivateKey" runat="server" CssClass="form-control" placeholder="private key from session" Enabled="false" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblIppoGlobalDeviceId" runat="server" AssociatedControlID="ippoGlobalDeviceId" CssClass="form-label" Text="Global Device ID"></asp:Label>
                                <asp:TextBox ID="ippoGlobalDeviceId" runat="server" CssClass="form-control" placeholder="Global Device ID" Text="m97999989" />
                            </div>
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblIppoType" runat="server" AssociatedControlID="ippoType" CssClass="form-label" Text="Type"></asp:Label>
                                <asp:DropDownList ID="ippoType" runat="server" CssClass="form-select">
                                    <asp:ListItem Value="IPPO" Selected="True">IPPO</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="position-relative d-inline-block">
                            <asp:Button
                                ...
                                Text="Read IPPO"
                                OnClick="btnIppoRead_Click"
                                OnClientClick="showIppoLoading(this); return true;" />
                        ...
                        <a href="IPPO.aspx" class="btn btn-secondary ms-2">Reset</a>
                        <asp:Label ID="lblIppoMessage" runat="server" CssClass="mt-3 d-block"></asp:Label>
                    </div>
                 </div>
                ...
                <asp:UpdatePanel ID="updResponse" runat="server">
                                ...
                                <div class="card-header border-0">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center gap-3">
                                            <h5 class="mb-0">IPPO Response</h5>
                                            <asp:Label ID="lblResponseStatus" runat="server" CssClass="badge bg-success px-3 py-2" />
                                        </div>
                                        <div>
                                            <asp:Button ID="btnIppoResponsePass" runat="server" CssClass="btn btn-success btn-sm" Text="Pass" OnClick="btnIppoResponsePass_Click" />
                                            <asp:Button ID="btnIppoResponseFail" runat="server" CssClass="btn btn-danger btn-sm ms-2" Text="Fail" OnClick="btnIppoResponseFail_Click" />
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">IPPO DateTime</small>
                                                    <asp:Label ID="lblRespIppoDateTime" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">Primary IP Address</small>
                                                    <asp:Label ID="lblRespPrimaryIpAddress" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">Secondary IP Address</small>
                                                    <asp:Label ID="lblRespSecondaryIpAddress" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">Primary Port</small>
                                                    <asp:Label ID="lblRespPrimaryPort" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">Secondary Port</small>
                                                    <asp:Label ID="lblRespSecondaryPort" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Response Remarks Section -->
                                    <div id="ippoResponseRemarks" runat="server" class="mt-3" style="display: none;">
                                        <div class="card border-warning">
                                            <div class="card-body">
                                                <h6 class="card-title">Remarks</h6>
                                                <asp:TextBox ID="txtIppoResponseRemarks" runat="server" CssClass="form-control mb-2" TextMode="MultiLine" Rows="2" placeholder="Enter remarks..."></asp:TextBox>
                                                <div class="mt-2">
                                                    <asp:Button ID="btnSaveIppoResponseRemarks" runat="server" CssClass="btn btn-dark-primary btn-sm me-1" Text="Save Remarks" OnClick="btnSaveIppoResponseRemarks_Click" />
                                                    <asp:Button ID="btnCancelIppoResponseRemarks" runat="server" CssClass="btn btn-secondary btn-sm ms-2" Text="Cancel" OnClick="btnCancelIppoResponseRemarks_Click" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="btnIppoRead" EventName="Click" />
                        <asp:AsyncPostBackTrigger ControlID="btnIppoResponsePass" EventName="Click" />
                        <asp:AsyncPostBackTrigger ControlID="btnIppoResponseFail" EventName="Click" />
                        <asp:AsyncPostBackTrigger ControlID="btnSaveIppoResponseRemarks" EventName="Click" />
                        <asp:AsyncPostBackTrigger ControlID="btnCancelIppoResponseRemarks" EventName="Click" />
                    </Triggers>
                </asp:UpdatePanel>
...
<asp:Content ID="ScriptsContent" ContentPlaceHolderID="ScriptsContent" runat="server">
    ...
    <script>
        function showIppoLoading(button) {
            if (!button) return;

            const spinner = document.getElementById('ippoSpinner');
        ...
        function disableIppoButton() {
            const button = document.getElementById('<%= btnIppoRead.ClientID %>');
            const spinner = document.getElementById('ippoSpinner');
