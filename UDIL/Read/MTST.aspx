<%@ Page Title="UDIL Tester - MTST - ODR" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
   CodeBehind="MTST.aspx.cs" Inherits="UDIL.Read.MTST" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

    <div class="main-content">
        <div class="container-fluid mt-5">
            <section id="mtst-read">
                <h2 class="section-header"><i class="bi bi-search"></i> MTST - On Demand Read</h2>
                <div class="card">

                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblMtstTransactionId" runat="server" AssociatedControlID="mtstTransactionId" CssClass="form-label" Text="Transaction ID"></asp:Label>
                                <asp:TextBox ID="mtstTransactionId" runat="server" CssClass="form-control" ReadOnly="true" />
                            </div>
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblMtstPrivateKey" runat="server" AssociatedControlID="mtstPrivateKey" CssClass="form-label" Text="Private Key"></asp:Label>
                                <asp:TextBox ID="mtstPrivateKey" runat="server" CssClass="form-control" placeholder="private key from session" Enabled="false" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblMtstGlobalDeviceId" runat="server" AssociatedControlID="mtstGlobalDeviceId" CssClass="form-label" Text="Global Device ID"></asp:Label>
                                <asp:TextBox ID="mtstGlobalDeviceId" runat="server" CssClass="form-control" placeholder="Global Device ID" Text="m97999989" />
                            </div>
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblMtstType" runat="server" AssociatedControlID="mtstType" CssClass="form-label" Text="Type"></asp:Label>
                                <asp:DropDownList ID="mtstType" runat="server" CssClass="form-select">
                                    <asp:ListItem Value="MTST" Selected="True">MTST</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="position-relative d-inline-block">
                            <asp:Button
                                ...
                                Text="Read MTST"
                                OnClick="btnMtstRead_Click"
                                OnClientClick="showMtstLoading(this); return true;" />
                        ...
                        <a href="MTST.aspx" class="btn btn-secondary ms-2">Reset</a>
                        <asp:Label ID="lblMtstMessage" runat="server" CssClass="mt-3 d-block"></asp:Label>
                    </div>
                 </div>
                ...
                <asp:UpdatePanel ID="updResponse" runat="server">
                                ...
                                <div class="card-header border-0">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center gap-3">
                                            <h5 class="mb-0">MTST Response</h5>
                                            <asp:Label ID="lblResponseStatus" runat="server" CssClass="badge bg-success px-3 py-2" />
                                        </div>
                                        <div>
                                            <asp:Button ID="btnMtstResponsePass" runat="server" CssClass="btn btn-success btn-sm" Text="Pass" OnClick="btnMtstResponsePass_Click" />
                                            <asp:Button ID="btnMtstResponseFail" runat="server" CssClass="btn btn-danger btn-sm ms-2" Text="Fail" OnClick="btnMtstResponseFail_Click" />
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">MTST DateTime</small>
                                                    <asp:Label ID="lblRespMtstDateTime" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">Meter Activation Status</small>
                                                    <asp:Label ID="lblRespMtstMeterActivationStatus" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Response Remarks Section -->
                                    <div id="mtstResponseRemarks" runat="server" class="mt-3" style="display: none;">
                                        <div class="card border-warning">
                                            <div class="card-body">
                                                <h6 class="card-title">Remarks</h6>
                                                <asp:TextBox ID="txtMtstResponseRemarks" runat="server" CssClass="form-control mb-2" TextMode="MultiLine" Rows="2" placeholder="Enter remarks..."></asp:TextBox>
                                                <div class="mt-2">
                                                    <asp:Button ID="btnSaveMtstResponseRemarks" runat="server" CssClass="btn btn-dark-primary btn-sm me-1" Text="Save Remarks" OnCommand="SaveRemarks_Command" CommandName="Save" CommandArgument="MTSTResponse" />
                                                    <asp:Button ID="btnCancelMtstResponseRemarks" runat="server" CssClass="btn btn-secondary btn-sm ms-2" Text="Cancel" OnCommand="CancelRemarks_Command" CommandName="Cancel" CommandArgument="MTSTResponse" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="btnMtstRead" EventName="Click" />
                        <asp:AsyncPostBackTrigger ControlID="btnMtstResponsePass" EventName="Click" />
                        <asp:AsyncPostBackTrigger ControlID="btnMtstResponseFail" EventName="Click" />
                        <asp:AsyncPostBackTrigger ControlID="btnSaveMtstResponseRemarks" EventName="Click" />
                        <asp:AsyncPostBackTrigger ControlID="btnCancelMtstResponseRemarks" EventName="Click" />
                    </Triggers>
                </asp:UpdatePanel>
...
<asp:Content ID="ScriptsContent" ContentPlaceHolderID="ScriptsContent" runat="server">
    ...
    <script>
        function showMtstLoading(button) {
            if (!button) return;

            const spinner = document.getElementById('mtstSpinner');
        ...
        function disableMtstButton() {
            const button = document.getElementById('<%= btnMtstRead.ClientID %>');
            const spinner = document.getElementById('mtstSpinner');
