<%@ Page Title="UDIL Tester - TIOU - ODR" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
   CodeBehind="TIOU.aspx.cs" Inherits="UDIL.Read.TIOU" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

    <div class="main-content">
        <div class="container-fluid mt-5">
            <section id="tiou-read">
                <h2 class="section-header"><i class="bi bi-search"></i> TIOU - On Demand Read</h2>
                <div class="card">

                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblTiouTransactionId" runat="server" AssociatedControlID="tiouTransactionId" CssClass="form-label" Text="Transaction ID"></asp:Label>
                                <asp:TextBox ID="tiouTransactionId" runat="server" CssClass="form-control" ReadOnly="true" />
                            </div>
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblTiouPrivateKey" runat="server" AssociatedControlID="tiouPrivateKey" CssClass="form-label" Text="Private Key"></asp:Label>
                                <asp:TextBox ID="tiouPrivateKey" runat="server" CssClass="form-control" placeholder="private key from session" Enabled="false" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblTiouGlobalDeviceId" runat="server" AssociatedControlID="tiouGlobalDeviceId" CssClass="form-label" Text="Global Device ID"></asp:Label>
                                <asp:TextBox ID="tiouGlobalDeviceId" runat="server" CssClass="form-control" placeholder="Global Device ID" Text="m97999989" />
                            </div>
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblTiouType" runat="server" AssociatedControlID="tiouType" CssClass="form-label" Text="Type"></asp:Label>
                                <asp:DropDownList ID="tiouType" runat="server" CssClass="form-select">
                                    <asp:ListItem Value="TIOU" Selected="True">TIOU</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="position-relative d-inline-block">
                            <asp:Button
                                ...
                                Text="Read TIOU"
                                OnClick="btnTiouRead_Click"
                                OnClientClick="showTiouLoading(this); return true;" />
                        ...
                        <asp:Label ID="lblTiouMessage" runat="server" CssClass="mt-3 d-block"></asp:Label>
                    </div>
                 </div>
                ...
                <asp:UpdatePanel ID="updResponse" runat="server">
                                ...
                                <div class="card-header border-0">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center gap-3">
                                            <h5 class="mb-0">TIOU Response</h5>
                                            <asp:Label ID="lblResponseStatus" runat="server" CssClass="badge bg-success px-3 py-2" />
                                        </div>
                                        <div>
                                            <asp:Button ID="btnTiouResponsePass" runat="server" CssClass="btn btn-success btn-sm" Text="Pass" OnClick="btnTiouResponsePass_Click" />
                                            <asp:Button ID="btnTiouResponseFail" runat="server" CssClass="btn btn-danger btn-sm ms-2" Text="Fail" OnClick="btnTiouResponseFail_Click" />
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">TIOU DateTime</small>
                                                    <asp:Label ID="lblRespTiouDateTime" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>

                                    <!-- TIOU Profiles Section -->
                                    <div class="mt-4">
                                        <!-- Day Profiles -->
                                        <div class="card mb-4">
                                            <div class="card-header">
                                                <h6 class="mb-0">Day Profiles</h6>
                                            </div>
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <asp:GridView ID="gvDayProfiles" runat="server" CssClass="table table-striped table-hover" AutoGenerateColumns="false" GridLines="None">
                                                        <Columns>
                                                            <asp:BoundField DataField="name" HeaderText="Profile Name" />
                                                            <asp:TemplateField HeaderText="Tariff Slabs">
                                                                <ItemTemplate>
                                                                    <asp:Repeater ID="rptTariffSlabs" runat="server" DataSource='<%# Eval("tariff_slabs") %>'>
                                                                        <ItemTemplate>
                                                                            <span class="badge bg-primary me-1"><%# Container.DataItem %></span>
                                                                        </ItemTemplate>
                                                                    </asp:Repeater>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        ...
                                                        <EmptyDataTemplate>
                                                            <div class="text-muted">No day profiles found.</div>
                                                        </EmptyDataTemplate>
                                                    </asp:GridView>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card mb-4">
                                            <div class="card-header">
                                                <h6 class="mb-0">Week Profiles</h6>
                                            </div>
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <asp:GridView ID="gvWeekProfiles" runat="server" CssClass="table table-striped table-hover" AutoGenerateColumns="false" GridLines="None">
                                                        <Columns>
                                                            <asp:BoundField DataField="name" HeaderText="Profile Name" />
                                                            <asp:TemplateField HeaderText="Weekly Day Profile">
                                                                <ItemTemplate>
                                                                    <asp:Repeater ID="rptWeeklyDayProfile" runat="server" DataSource='<%# Eval("weekly_day_profile") %>'>
                                                                        <ItemTemplate>
                                                                            <span class="badge bg-info me-1"><%# Container.DataItem %></span>
                                                                        </ItemTemplate>
                                                                    </asp:Repeater>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        ...
                                                        <EmptyDataTemplate>
                                                            <div class="text-muted">No week profiles found.</div>
                                                        </EmptyDataTemplate>
                                                    </asp:GridView>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card mb-4">
                                            <div class="card-header">
                                                <h6 class="mb-0">Season Profiles</h6>
                                            </div>
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <asp:GridView ID="gvSeasonProfiles" runat="server" CssClass="table table-striped table-hover" AutoGenerateColumns="false" GridLines="None">
                                                        <Columns>
                                                            <asp:BoundField DataField="name" HeaderText="Season Name" />
                                                            <asp:BoundField DataField="week_profile_name" HeaderText="Week Profile Name" />
                                                            <asp:BoundField DataField="start_date" HeaderText="Start Date" />
                                                        </Columns>
                                                        <EmptyDataTemplate>
                                                            <div class="text-muted">No season profiles found.</div>
                                                        </EmptyDataTemplate>
                                                    </asp:GridView>
                                                </div>
                                            </div>
                                    ...
                                    <div id="tiouResponseRemarks" runat="server" class="mt-3" style="display: none;">
                                        <div class="card border-warning">
                                            <div class="card-body">
                                                <h6 class="card-title">Remarks</h6>
                                                <asp:TextBox ID="txtTiouResponseRemarks" runat="server" CssClass="form-control mb-2" TextMode="MultiLine" Rows="2" placeholder="Enter remarks..."></asp:TextBox>
                                                <div class="mt-2">
                                                    <asp:Button ID="btnSaveTiouResponseRemarks" runat="server" CssClass="btn btn-dark-primary btn-sm me-1" Text="Save Remarks" OnClick="btnSaveTiouResponseRemarks_Click" />
                                                    <asp:Button ID="btnCancelTiouResponseRemarks" runat="server" CssClass="btn btn-secondary btn-sm ms-2" Text="Cancel" OnClick="btnCancelTiouResponseRemarks_Click" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="btnTiouRead" EventName="Click" />
                        <asp:AsyncPostBackTrigger ControlID="btnTiouResponsePass" EventName="Click" />
                        <asp:AsyncPostBackTrigger ControlID="btnTiouResponseFail" EventName="Click" />
                        <asp:AsyncPostBackTrigger ControlID="btnSaveTiouResponseRemarks" EventName="Click" />
                        <asp:AsyncPostBackTrigger ControlID="btnCancelTiouResponseRemarks" EventName="Click" />
                    </Triggers>
                </asp:UpdatePanel>
...
<asp:Content ID="ScriptsContent" ContentPlaceHolderID="ScriptsContent" runat="server">
    ...
    <script>
        function showTiouLoading(button) {
            if (!button) return;

            const spinner = document.getElementById('tiouSpinner');
        ...
        function disableTiouButton() {
            const button = document.getElementById('<%= btnTiouRead.ClientID %>');
            const spinner = document.getElementById('tiouSpinner');
