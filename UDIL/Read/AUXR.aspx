<%@ Page Title="UDIL Tester - AUXR - ODR" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
   CodeBehind="AUXR.aspx.cs" Inherits="UDIL.Read.AUXR" %>
    ...
    <div class="main-content">
        <div class="container-fluid mt-5">
            <section id="auxr-read">
                <h2 class="section-header"><i class="bi bi-search"></i> AUXR - On Demand Read</h2>
                <div class="card">

                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblAuxrTransactionId" runat="server" AssociatedControlID="auxrTransactionId" CssClass="form-label" Text="Transaction ID"></asp:Label>
                                <asp:TextBox ID="auxrTransactionId" runat="server" CssClass="form-control" ReadOnly="true" />
                            </div>
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblAuxrPrivateKey" runat="server" AssociatedControlID="auxrPrivateKey" CssClass="form-label" Text="Private Key"></asp:Label>
                                <asp:TextBox ID="auxrPrivateKey" runat="server" CssClass="form-control" placeholder="private key from session" Enabled="false" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblAuxrGlobalDeviceId" runat="server" AssociatedControlID="auxrGlobalDeviceId" CssClass="form-label" Text="Global Device ID"></asp:Label>
                                <asp:TextBox ID="auxrGlobalDeviceId" runat="server" CssClass="form-control" placeholder="Global Device ID" Text="m97999989" />
                            </div>
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblAuxrType" runat="server" AssociatedControlID="auxrType" CssClass="form-label" Text="Type"></asp:Label>
                                <asp:DropDownList ID="auxrType" runat="server" CssClass="form-select">
                                    <asp:ListItem Value="AUXR" Selected="True">AUXR</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                        </div>
                        ...
                        <a href="AUXR.aspx" class="btn btn-secondary ms-2">Reset</a>
                                ...
                                <div class="card-header border-0">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="d-flex align-items-center gap-3">
                                            <h5 class="mb-0">AUXR Response</h5>
                                            <asp:Label ID="lblResponseStatus" runat="server" CssClass="badge bg-success px-3 py-2" />
                                        </div>
                                        <div>
                                            <asp:Button ID="btnAuxrResponsePass" runat="server" CssClass="btn btn-success btn-sm" Text="Pass" OnClick="btnAuxrResponsePass_Click" />
                                            <asp:Button ID="btnAuxrResponseFail" runat="server" CssClass="btn btn-danger btn-sm ms-2" Text="Fail" OnClick="btnAuxrResponseFail_Click" />
                                        </div>
                                    </div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">AUXR DateTime</small>
                                                    <asp:Label ID="lblRespAuxrDateTime" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="card h-100 border-light">
                                                <div class="card-body">
                                                    <small class="text-muted d-block">AUXR Status</small>
                                                    <asp:Label ID="lblRespAuxrStatus" runat="server" CssClass="fw-bold" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Response Remarks Section -->
                                    <div id="auxrResponseRemarks" runat="server" class="mt-3" style="display: none;">
                                        <div class="card border-warning">
                                            <div class="card-body">
                                                <h6 class="card-title">Remarks</h6>
                                                <asp:TextBox ID="txtAuxrResponseRemarks" runat="server" CssClass="form-control mb-2" TextMode="MultiLine" Rows="2" placeholder="Enter remarks..."></asp:TextBox>
                                                <div class="mt-2">
                                                    <asp:Button ID="btnSaveAuxrResponseRemarks" runat="server" CssClass="btn btn-dark-primary btn-sm me-1" Text="Save Remarks" OnClick="btnSaveAuxrResponseRemarks_Click" />
                                                    <asp:Button ID="btnCancelAuxrResponseRemarks" runat="server" CssClass="btn btn-secondary btn-sm ms-2" Text="Cancel" OnClick="btnCancelAuxrResponseRemarks_Click" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
