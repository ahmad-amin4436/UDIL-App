<%@ Page Title="UDIL Tester - Instantaneous Data" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
   CodeBehind="instantaneous_data.aspx.cs" Inherits="UDIL.EventsDataTables.instantaneous_data" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-responsive" style="max-height: 600px; overflow-y: auto;">
                            <asp:GridView ID="gvInstantaneousData" runat="server" CssClass="table table-striped table-hover table-bordered" 
                                AutoGenerateColumns="true" 
                                GridLines="None" 
                                AllowPaging="true" 
                                PageSize="50" 
                                OnPageIndexChanging="gvInstantaneousData_PageIndexChanging"
                                OnDataBound="gvInstantaneousData_DataBound"
                                ...
                                <EmptyDataTemplate>
                                    <div class="text-center text-muted py-5">
                                        ...
                                        <p class="mt-2">No instantaneous data found.</p>
                                    </div>
                                </EmptyDataTemplate>
                                <PagerTemplate>
                                        ...
                                        <nav aria-label="Page navigation">
                                            <ul class="pagination pagination-sm mb-0">
                                                ...
                                                <asp:Repeater ID="rptPageNumbers" runat="server" OnItemCommand="rptPageNumbers_ItemCommand">
                                                    <ItemTemplate>
                                                        <li class='<%# Container.DataItem.ToString() == gvInstantaneousData.PageIndex.ToString() ? "page-item active" : "page-item" %>'>
