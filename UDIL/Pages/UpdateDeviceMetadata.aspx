                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <asp:TextBox ID="dmRequestDateTime" runat="server" TextMode="DateTimeLocal" Text="2024-08-31T14:30:00" CssClass="form-control" />
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <asp:TextBox ID="dmInitialCommunicationTime" runat="server" CssClass="form-control" TextMode="Time" Text="00:00" />
                            </div>
                            <div class="col-md-4 mb-3">
                ...
                <asp:UpdatePanel ID="updDataTables" runat="server">
                    <ContentTemplate>
                        <asp:Panel ID="pnlDataTables" runat="server" Visible="false" CssClass="mt-4">
                            ...
                            <asp:Timer ID="timerTables" runat="server" Interval="10000"
