                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <asp:TextBox ID="msRequestDateTime" runat="server" Text="2025-12-03T17:56:00" CssClass="form-control" TextMode="DateTimeLocal" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="gvMeterVisuals" runat="server" CssClass="table table-striped table-hover"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="mtst_meter_activation_status" HeaderText="Meter Activation Status" />
                                            </Columns>
                                            <EmptyDataTemplate>
