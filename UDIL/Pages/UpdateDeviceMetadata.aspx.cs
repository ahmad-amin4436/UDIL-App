...
{
    public partial class UpdateDeviceMetadata : UDIL.AuthenticatedPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                dmRequestDateTime.Text = DateTime.Now.ToString("yyyy-MM-ddTHH:mm:ss");
                dmInitialCommunicationTime.Text = DateTime.Now.ToString("HH:mm");
        ...
        protected void SaveRemarks_Command(object sender, CommandEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    HandleTableAction(tableName + "Table - Update Device Metadata", "Fail", remarks);
        ...
        private void SaveApiTestResult(string transactionId, string status, string remarks)
        {
            try
            {
                ...
                UDIL.DAL.TestResult testResult = new UDIL.DAL.TestResult
                {
                    ...
                    TestName = "UpdateDeviceMetadataAPI",
                    TestType = "API",
                    Status = status,
                    Remarks = remarks,
