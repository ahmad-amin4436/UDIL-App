...
{
    public partial class LoadSheddingScheduling : UDIL.AuthenticatedPage
    {
        ...
        protected void SaveRemarks_Command(object sender, CommandEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    HandleTableAction(tableName + "Table - Load Shedding Schedule", "Fail", remarks);
        ...
        private void SaveApiTestResult(string transactionId, string status, string remarks)
        {
            try
            {
                ...
                UDIL.DAL.TestResult testResult = new UDIL.DAL.TestResult
                {
                    ...
                    TestName = "LoadSheddingScheduleAPI",
                    TestType = "API",
                    Status = status,
                    Remarks = remarks,
