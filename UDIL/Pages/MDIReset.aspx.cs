...
{
    public partial class MDIReset : UDIL.AuthenticatedPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                mrRequestDateTime.Text = DateTime.Now.ToString("yyyy-MM-ddTHH:mm:ss");
                mrMdiResetTime.Text = DateTime.Now.ToString("HH:mm");
        ...
        protected void SaveRemarks_Command(object sender, CommandEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    HandleTableAction(tableName + "Table - MDI Reset", "Fail", remarks);
