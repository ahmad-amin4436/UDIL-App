                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="gvMeterVisuals" runat="server" CssClass="table table-striped table-hover" AutoGenerateColumns="false" GridLines="None">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="ippo_datetime" HeaderText="IP Port DateTime" />
                                                <asp:BoundField DataField="ippo_primary_ip_address" HeaderText="Primary IP Address" />
                                                <asp:BoundField DataField="ippo_primary_port" HeaderText="Primary Port" />
                                                <asp:BoundField DataField="ippo_secondary_ip_address" HeaderText="Secondary IP Address" />
                                                <asp:BoundField DataField="ippo_secondary_port" HeaderText="Secondary Port" />
                                            </Columns>
                                            <EmptyDataTemplate>
