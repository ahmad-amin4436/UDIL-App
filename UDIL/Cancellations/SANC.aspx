<%@ Page Title="UDIL Tester - SANC Cancellation" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
   CodeBehind="SANC.aspx.cs" Inherits="UDIL.Cancellations.SANC" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
   
    <div class="main-content">
        <div class="container-fluid mt-5">
            <section id="sanc-cancellation">
                <h2 class="section-header"> <i class="bi bi-x-circle"></i> SANC Cancellation</h2>
                <div class="card">
                   
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblScTransactionId" runat="server" AssociatedControlID="scTransactionId" CssClass="form-label" Text="Transaction ID"></asp:Label>
                                <asp:TextBox ID="scTransactionId" runat="server" CssClass="form-control" ReadOnly="true" />
                            </div>
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblScPrivateKey" runat="server" AssociatedControlID="scPrivateKey" CssClass="form-label" Text="Private Key"></asp:Label>
                                <asp:TextBox ID="scPrivateKey" runat="server" CssClass="form-control" placeholder="private key from session" Enabled="false" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblScGlobalDeviceId" runat="server" AssociatedControlID="scGlobalDeviceId" CssClass="form-label" Text="Global Device ID"></asp:Label>
                                <asp:TextBox ID="scGlobalDeviceId" runat="server" CssClass="form-control" placeholder="Global Device ID" Text="m99999997" />
                            </div>
                        </div>
                        <div class="position-relative d-inline-block">
                            <asp:Button
                                ID="btnSANCCancellation"
                                runat="server"
                                CssClass="btn btn-dark-primary"
                                Text="Send SANC Cancellation"
                                OnClick="btnSANCCancellation_Click"
                                OnClientClick="showSANCCancellationLoading(this); return true;" />

                            <span id="sancCancellationSpinner"
                        ...
                        <asp:Label ID="lblSANCCancellationMessage" runat="server" CssClass="mt-3 d-block"></asp:Label>
                    </div>
                  ...
                  <asp:UpdatePanel ID="updTracker" runat="server">
                          ...
                          <asp:Panel ID="pnlTracker" runat="server" Visible="false" CssClass="card shadow-sm border-0 mt-4">
                              ...
                              <div class="card-header border-0">
                                  <div class="d-flex justify-content-between align-items-center">
                                      <div>
                                          <h5 class="mb-0">SANC Cancellation Tracker</h5>
                    ...
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="btnSANCCancellation" EventName="Click" />
                    </Triggers>
                </asp:UpdatePanel>
                ...
                <asp:UpdatePanel ID="updDataTables" runat="server">
                    <ContentTemplate>
                        <asp:Panel ID="pnlDataTables" runat="server" Visible="false" CssClass="mt-4">
                            <h4 class="mb-4">SANC Cancellation Data Tables</h4>
                                        ...
                                        <asp:GridView ID="gvMeterVisuals" runat="server" CssClass="table table-striped table-hover" AutoGenerateColumns="false" GridLines="None">
                                            <Columns>
                                               <asp:BoundField DataField="msn" HeaderText="MSN" />
                                                ...
                                                <asp:BoundField DataField="sanc_datetime" HeaderText="Sanc DateTime" />
                                                <asp:BoundField DataField="sanc_load_limit" HeaderText="Maximum Retries" />
                                                <asp:BoundField DataField="sanc_maximum_retries" HeaderText="Maximum Retries" />
                                                <asp:BoundField DataField="sanc_retry_interval" HeaderText="Retry Interval" />
                                                <asp:BoundField DataField="sanc_threshold_duration" HeaderText="Threshold Duration" />
                                                <asp:BoundField DataField="sanc_retry_clear_interval" HeaderText="Retry Clear Interval" />
...
<asp:Content ID="ScriptsContent" ContentPlaceHolderID="ScriptsContent" runat="server">
    <script>
        function showSANCCancellationLoading(button) {
            if (!button) return;

            const spinner = document.getElementById('sancCancellationSpinner');
        ...
        function disableSANCCancellationButton() {
            const button = document.getElementById('<%= btnSANCCancellation.ClientID %>');
            const spinner = document.getElementById('sancCancellationSpinner');
        ...
        function resetSANCCancellationLoading() {
            const button = document.getElementById('<%= btnSANCCancellation.ClientID %>');
            const spinner = document.getElementById('sancCancellationSpinner');
            ...
            if (button) {
                ...
                const originalText = 'Send SANC Cancellation';
                if (originalText) {
