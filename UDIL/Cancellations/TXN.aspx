<%@ Page Title="UDIL Tester - Transaction Cancellation" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
   CodeBehind="TXN.aspx.cs" Inherits="UDIL.Cancellations.TXN" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
   
    <div class="main-content">
        <div class="container-fluid mt-5">
            <section id="txn-cancellation">
                <h2 class="section-header"> <i class="bi bi-x-circle"></i> Transaction Cancellation</h2>
                <div class="card">
                   
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblTxnTransactionId" runat="server" AssociatedControlID="txnTransactionId" CssClass="form-label" Text="Transaction ID"></asp:Label>
                                <asp:TextBox ID="txnTransactionId" runat="server" CssClass="form-control"  />
                            </div>
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblTxnPrivateKey" runat="server" AssociatedControlID="txnPrivateKey" CssClass="form-label" Text="Private Key"></asp:Label>
                                <asp:TextBox ID="txnPrivateKey" runat="server" CssClass="form-control" placeholder="private key from session" Enabled="false" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblTxnGlobalDeviceId" runat="server" AssociatedControlID="txnGlobalDeviceId" CssClass="form-label" Text="Global Device ID"></asp:Label>
                                <asp:TextBox ID="txnGlobalDeviceId" runat="server" CssClass="form-control" placeholder="Global Device ID" Text="m99999997" />
                            </div>
                            <div class="col-md-6 mb-3">
                                <asp:Label ID="lblTxnRequestDatetime" runat="server" AssociatedControlID="txnRequestDatetime" CssClass="form-label" Text="Request DateTime"></asp:Label>
                                <asp:TextBox ID="txnRequestDatetime" runat="server" CssClass="form-control" placeholder="YYYY-MM-DD HH:mm:ss" Text="2023-02-01 17:28:00" />
                            </div>
                        </div>
                        <div class="position-relative d-inline-block">
                            <asp:Button
                                ID="btnTXNCancellation"
                                runat="server"
                                CssClass="btn btn-dark-primary"
                                Text="Send Transaction Cancellation"
                                OnClick="btnTXNCancellation_Click"
                                OnClientClick="showTXNCancellationLoading(this); return true;" />

                            <span id="txnCancellationSpinner"
                                class="position-absolute top-50 start-50 translate-middle"
                                style="display: none;">
                                <span class="spinner-border spinner-border-sm"></span>
                            </span>
                        </div>
                        <a href="TXN.aspx" class="btn btn-secondary ms-2">Reset</a>
                        <asp:Label ID="lblTXNCancellationMessage" runat="server" CssClass="mt-3 d-block"></asp:Label>
                    </div>
                  ...
                  <asp:UpdatePanel ID="updTracker" runat="server">
                          ...
                          <asp:Panel ID="pnlTracker" runat="server" Visible="false" CssClass="card shadow-sm border-0 mt-4">
                              ...
                              <div class="card-header border-0">
                                  <div class="d-flex justify-content-between align-items-center">
                                      <div>
                                          <h5 class="mb-0">Transaction Cancellation Tracker</h5>
                    ...
                    <Triggers>
                        <asp:AsyncPostBackTrigger ControlID="btnTXNCancellation" EventName="Click" />
                    </Triggers>
                </asp:UpdatePanel>
                ...
                <asp:UpdatePanel ID="updDataTables" runat="server">
                    <ContentTemplate>
                        <asp:Panel ID="pnlDataTables" runat="server" Visible="false" CssClass="mt-4">
                            <h4 class="mb-4">Transaction Cancellation Data Tables</h4>
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="gvMeterVisuals" runat="server" CssClass="table table-striped table-hover" AutoGenerateColumns="false" GridLines="None">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="sanc_status" HeaderText="SANC Status" />
                                                <asp:BoundField DataField="sanc_datetime" HeaderText="SANC Date Time" />
...
<asp:Content ID="ScriptsContent" ContentPlaceHolderID="ScriptsContent" runat="server">
    <script>
        function showTXNCancellationLoading(button) {
            if (!button) return;

            const spinner = document.getElementById('txnCancellationSpinner');
        ...
        function disableTXNCancellationButton() {
            const button = document.getElementById('<%= btnTXNCancellation.ClientID %>');
            const spinner = document.getElementById('txnCancellationSpinner');
        ...
        function resetTXNCancellationLoading() {
            const button = document.getElementById('<%= btnTXNCancellation.ClientID %>');
            const spinner = document.getElementById('txnCancellationSpinner');
            ...
            if (button) {
                ...
                const originalText = 'Send Transaction Cancellation';
                if (originalText) {
