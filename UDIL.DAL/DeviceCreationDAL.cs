...
namespace UDIL.DAL
{
    public class DeviceCreationDAL
    {
        private string connectionString;
        public DeviceCreationDAL()
        {
            // Default constructor - use Web.config connection string
            connectionString = ConfigurationManager.ConnectionStrings["DefaultConnection"]?.ConnectionString;
        }

        public DeviceCreationDAL(string connectionString)
        {
                ...
                using (MySqlConnection connection = new MySqlConnection(connectionString))
                {
                    ...
                    string query = @"
                        SELECT 
                            ...
                            last_command_resp, dmdt_meter_type, dmdt_bidirectional_device,
                            dmdt_communication_mode, dmdt_communication_type, 
                            dmdt_communication_interval, dmdt_initial_communication_time,
                            dmdt_phase, mdi_reset_date, mdi_reset_time, msim_id
                        FROM meter_visuals
